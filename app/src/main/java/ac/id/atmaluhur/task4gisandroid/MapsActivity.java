package ac.id.atmaluhur.task4gisandroid;
...
import ac.id.atmaluhur.task4gisandroid.api.ApiClient;
import ac.id.atmaluhur.task4gisandroid.api.ApiService;
import ac.id.atmaluhur.task4gisandroid.model.ListLocationModel;
import ac.id.atmaluhur.task4gisandroid.model.LocationModel;
